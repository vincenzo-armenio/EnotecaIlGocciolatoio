...
insert into prodotto(nome,descrizione,prezzo,immagine,anno,regione,gradazione,formato,quantita_acquistata, quantita_magazzino, nome_categoria)
values('Montepulciano D Abruzzo "NEGUS"','Cascina del Colle, vino rosso. ', 36, './img/montepulciano.jpg', 2013, 'Abruzzo', 16,75,0,0,'Vino' );

insert into prodotto(nome,descrizione,prezzo,immagine,anno,regione,gradazione,formato,quantita_acquistata, quantita_magazzino, nome_categoria)
values('Doppio Magnum','Doppio Magnum 3 Litri Montepulciano d Abruzzo RISERVA in Cassa Legno Fattoria Giuseppe Savini ', 36, './img/doppiomagnum.jpg', 2012, 'Abruzzo', 14,300,0,0,'Vino' );

insert into prodotto(nome,descrizione,prezzo,immagine,anno,regione,gradazione,formato,quantita_acquistata, quantita_magazzino, nome_categoria)
values('Champagne Brut "Cristal"','Uno Champagne che è pregevole se sorseggiato in meditazione. Ottimo anche in abbinamento a cibi delicati e pregiati come il caviale, il pesce, i molluschi e i crostacei tipo l’aragosta, l’astice, e le ostriche. Va servito alla temperatura di 8° C.', 225, './img/brutcristal.jpg', 2012, 'Francia', 12,75,0,0,'Champagne' );
...
insert into prodotto(nome,descrizione,prezzo,immagine,anno,regione,gradazione,formato,quantita_acquistata, quantita_magazzino, nome_categoria)
values('Champagne BELLE EPOQUE','Col tempo, quest’assemblaggio complesso ha sviluppato una ricchezza aromatica eccezionale, armoniosa ed equilibrata. All’inizio ritroviamo aromi di frutta bianca con cenni di ananas e fiori bianchi primaverili. ', 158, './img/belleepoque.jpg', 2012, 'Francia', 12,75,0,0,'Champagne' );

insert into prodotto(nome,descrizione,prezzo,immagine,regione,gradazione,formato,quantita_acquistata, quantita_magazzino, nome_categoria)
values('Daarbulah 6X','Realizzata con una miscela di malti torrefatti e caramellati, aggiunta di avena e zucchero di canna grezzo, Daarbulah del birrificio Hammer è una birra in stile Imperial Stout dal colore scuro.', 132, './img/daarbulah.jpg', 'Francia', 25,33,0,0,'Birra' );
